...
export async function POST(req: NextRequest) {
    try {
        ...
        console.log(data);
        if (!data.email || !data.prefCompany1 || !data.prefCompany2 || !data.prefCompany3 || !data.prefCompany4) {
        ...
        return NextResponse.json({ message: "Company preference updated successfully" }, { status: 200 });
    } catch (e) {
