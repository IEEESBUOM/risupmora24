...
export async function POST(req: NextRequest) {
    try{
        const {coordinatorName, companyId, email, password}: Request = await req.json();
        ...
        if(excistCompanyCoordinator){
            return NextResponse.json({message: "A company coordinator already allocated for this company "}, {status: 400});
        }
        ...
        return NextResponse.json({message: "Company coordinator added successfully"}, {status: 200});
