  ...
  return (
    <div className="sm:h-screen grid justify-center content-between">
        ...
        <div className=" grid justify-center">
          ...
          <button onMouseEnter={animate} onMouseLeave={reverseAnimate} className="  w-[140px] h-[50px] bg-custom-black font-quicksand text-white rounded-full border-none outline-none cursor-pointer  shadow-[0_15px_30px_rgba(0,0,0,0.5)] overflow-hidden">
            ...
            <div className="flex gap-3 custom-animation">
              ...
              <div className="custom-animation text-custom-yellow">
                WELCOME
              </div>
            </span>
          </button>
