    ...
    <div className="sm:h-screen grid justify-center content-between">
      ...
      <div className=" grid justify-center">
        {session?.user.email ? (
          ...
          className=" cursor-default   w-[140px] h-[50px] bg-custom-black font-quicksand text-white rounded-full border-none outline-none  shadow-[0_15px_30px_rgba(0,0,0,0.5)] overflow-hidden"
        >
          <div  className=" grid  justify-center items-center gap-16 py-4 text-xs font-medium tracking-wider">
